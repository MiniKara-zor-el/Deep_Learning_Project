...
def main(args):
    ...
    model=train(model, train_loader, validation_loader, loss_criterion, optimizer, device, hook) # calling the train function to start the training
    '''
    ...
    test(model, test_loader, loss_criterion, device, hook) # testing model
